 ...
 */
export const analyzeWithGemini = async (base64Image, prompt = "Analyze this 3D pose and environment. Describe any safety risks or anomalies seen.") => {
  const base64Data = base64Image.split(',')[1];
  
  // API Configuration
  const API_KEY = "AIzaSyAtnCO3swn_Bvtg8dlf1OXXcVo-wx5iftI"; 
